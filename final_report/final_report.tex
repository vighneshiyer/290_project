...
\begin{figure}
  \begin{tabular}{l l l l l}
    ...
    \bottomrule
  \end{tabular}
  \caption{Baseline execution of \texttt{rv64ui-p-add} on Rocket + Gemmini. All numbers are in mW. Switching (i.e. glitch) power (< 1\%) is lumped into the total.}
\end{figure}

\iffalse
rv64ui-p-add on Genus DB, many nets are not asserted!, trying propagate_activity
---------------------------- Annotation Report ----------------------------
...
Sequential Outputs                                                        
  Memory                     0           0            0       0        N/A
  Flop                   62745       26542            0   89287     70.27%
  Latch                      0           0            0       0        N/A
  Arch ICGC                  0           0            0       0        N/A
  Inferred ICGC              0        4307            0    4307      0.00%
  Total ICGC                 0        4307            0    4307      0.00%
Drivers                                                                   
  Driver nets           122915      649477        36073  808465     15.91%
  RTL Driver nets       122780      400766        23748  547294     23.45%
DFT                                                                       
